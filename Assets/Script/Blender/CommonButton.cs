...
public enum E_COMMON_BUTTON_STYLE
{
    ...
    COMMON_STAGE_HARD = 2,
    COMMON_BLOCK_RED = 3,
    COMMON_BLOCK_YELLOW = 4,
    COMMON_BLOCK_BLUE = 5,
    COMMON_BLOCK_GREEN = 6,
    COMMON_BLOCK_PURPLE = 7,
    COMMON_BLOCK_WHITE = 8,
    COMMON_NONE = 999999,
}
...
public class CommonButtonStyle
{
    ...
    */
    ...
    static private void ReadStyle()
    {
        ...
        m_CommonButtonStyleList.Add(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_RED, new CommonButtonStyle(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_RED, "Block_1", "Block_1", "Block_1", Vector3.zero, E_COMMON_BUTTON_BLOCK_OPTION.COLOR, true)); //E_COMMON_TEXTLAYOUT_STYLE.NONE, E_COMMON_TEXTLAYOUT_STYLE.NONE));
        m_CommonButtonStyleList.Add(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_YELLOW, new CommonButtonStyle(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_YELLOW, "Block_2", "Block_2", "Block_2", Vector3.zero, E_COMMON_BUTTON_BLOCK_OPTION.COLOR, true)); //E_COMMON_TEXTLAYOUT_STYLE.NONE, E_COMMON_TEXTLAYOUT_STYLE.NONE));
        m_CommonButtonStyleList.Add(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_BLUE, new CommonButtonStyle(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_BLUE, "Block_3", "Block_3", "Block_3", Vector3.zero, E_COMMON_BUTTON_BLOCK_OPTION.COLOR, true)); //E_COMMON_TEXTLAYOUT_STYLE.NONE, E_COMMON_TEXTLAYOUT_STYLE.NONE));
        m_CommonButtonStyleList.Add(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_GREEN, new CommonButtonStyle(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_GREEN, "Block_4", "Block_4", "Block_4", Vector3.zero, E_COMMON_BUTTON_BLOCK_OPTION.COLOR, true)); //E_COMMON_TEXTLAYOUT_STYLE.NONE, E_COMMON_TEXTLAYOUT_STYLE.NONE));
        m_CommonButtonStyleList.Add(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_PURPLE, new CommonButtonStyle(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_PURPLE, "Block_5", "Block_5", "Block_5", Vector3.zero, E_COMMON_BUTTON_BLOCK_OPTION.COLOR, true)); //E_COMMON_TEXTLAYOUT_STYLE.NONE, E_COMMON_TEXTLAYOUT_STYLE.NONE));
        m_CommonButtonStyleList.Add(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_WHITE, new CommonButtonStyle(E_COMMON_BUTTON_STYLE.COMMON_BLOCK_WHITE, "Block_6", "Block_6", "Block_6", Vector3.zero, E_COMMON_BUTTON_BLOCK_OPTION.COLOR, true)); //E_COMMON_TEXTLAYOUT_STYLE.NONE, E_COMMON_TEXTLAYOUT_STYLE.NONE));
